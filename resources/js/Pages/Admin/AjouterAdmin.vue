    ...
    <div class="text-sm">
        <div class="grid grid-cols-12 border-b-2 border-white">
            ...
            <div class="col-span-2 bg-blue-400 py-2 font-bold text-white">
                <p class="text-center">Statue d'admin </p>
            </div>
        ...
        <div class="grid grid-cols-12 border-b-2 border-white" v-for="(value,index) in donne.tousCompte" :key="index" >
            <div class="col-span-1  bg-stone-400 py-2 font-bold text-white">
               <div class="flex justify-around items-center">
                    <div class="">
                        <p class="px-3 py-1 bg-blue-500 rounded-full">
                            {{ donne.tousCompte.indexOf(value) + 1 }}
                        </p>
                    </div>
               </div>
            </div>
            ...
            <div class="col-span-2 bg-blue-400 py-2 font-bold text-white">
                <p class="text-center">
                    <i class="px-2 py-1 fas fa-check rounded-full bg-green-800" v-if="value.admin"></i>
            ...
            <div class="col-span-2 bg-purple-400 py-2 font-bold text-white">
                <div class="flex justify-around items-center" :class="value.email==='admin@gmail.com'?'hidden':''">
                    <div class="" v-if="!value.admin">
                        <button class="btn" @click.prevent="ajouter(value.email)">Ajouter d'admis</button>
                    </div>
                    <div class="" v-if="value.admin" > 
